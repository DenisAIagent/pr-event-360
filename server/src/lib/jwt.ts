...
// ── Session espace journaliste : JWT en cookie httpOnly (typ:'jspace').
// Remplace le stockage du bearer d'accès brut dans le cookie. Porte l'id du
// journaliste + son événement ; les droits (accréditation acceptée) sont relus en base.
